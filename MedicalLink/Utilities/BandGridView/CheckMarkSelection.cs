...
namespace MedicalLink.Utilities.BandGridView
{
        ...
        void View_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (info.Column == column)
                {
                    ...
                    object val = _view.GetFocusedRowCellValue("ShippedDate");
                    if (info.InRowCell && val.ToString().Equals(""))
                    {
                ...
                //if (IsGroupRowSelected(info.RowHandle))
                //{
                //    if (!IsRowSelected(info.RowHandle))
                //    {
                //        SelectRow(info.RowHandle, true, true);
                //    }
                //    else
                //    {
                //        SelectRow(info.RowHandle, false, true);
                //    }
                //}
            }
            catch (Exception ex)
