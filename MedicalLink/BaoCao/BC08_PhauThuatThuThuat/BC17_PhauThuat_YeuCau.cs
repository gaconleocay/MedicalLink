...
namespace MedicalLink.BaoCao
{
    ...
    /// 
    /// </summary>
    public partial class BC17_PhauThuat_YeuCau : UserControl
    {
        #region Declaration
        ...
        #region Load
        public BC17_PhauThuat_YeuCau()
        {
            InitializeComponent();
        }

        private void BC17_PhauThuat_YeuCau_Load(object sender, EventArgs e)
        {
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    O2S_Common.Utilities.ThongBao.frmThongBao frmthongbao = new O2S_Common.Utilities.ThongBao.frmThongBao(MedicalLink.Base.ThongBaoLable.CHUA_CHON_DICH_VU);
                    frmthongbao.Show();
                }
            }
            catch (Exception ex)
        ...
        private void tbnPrintBCPTTT_Click()
        {
            ...
            try
            {
                ...
                string fileTemplatePath = "BC_PhauThuat_YeuCau.xlsx";
                Utilities.PrintPreview.PrintPreview_ExcelFileTemplate.UsingExcelTemplate(fileTemplatePath, thongTinThem, dataBCPhauThuat_YC);
            }
            catch (Exception ex)
            {
                O2S_Common.Logging.LogSystem.Error(ex);
