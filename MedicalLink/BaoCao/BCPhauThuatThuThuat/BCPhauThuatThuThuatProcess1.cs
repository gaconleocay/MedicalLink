    ...
    public partial class BCPhauThuatThuThuat : UserControl
    {
        internal void LayDuLieuBaoCao_ChayMoi()
        {
            ...
            try
            {
                ...
                string serf_bhyt_groupcode = " bhyt_groupcode in ('06PTTT','07KTC') ";
                string ser_bhyt_groupcode = " ser.bhyt_groupcode in ('06PTTT','07KTC') ";
                ...
                {
                    tieuchi_date = " and pttt.phauthuatthuthuatdate between'" + tungay + "' and '" + denngay + "' ";
                }
                else
                {
                ...
                {
                    ser_departmentid = " and ser.departmentid in (285,34) ";
                ...
                {
                    ser_departmentid = " and ser.departmentid=122 ";
                    serf_pttt_loaiid = " pttt_loaiid in (1,2,3,4) ";
                ...
                {
                    ser_departmentid = " and ser.departmentid=116 ";
                    serf_pttt_loaiid = " pttt_loaiid in (1,2,3,4) ";
                ...
                {
                    ser_departmentid = " and ser.departmentid in (269,335,80,212) ";
                    serf_pttt_loaiid = " pttt_loaiid in (1,2,3,4) ";
                ...
                {
                    ser_departmentid = " and ser.departmentid in (";
                ...
                {
                    ser_departmentid = " and ser.departmentid in (80,212) ";
                ...
                {
                    ser_departmentid = " and ser.departmentid not in (80,212) ";
                    serf_pttt_loaiid = " pttt_loaiid in (5,6,7,8) ";
                ...
                else if (cboLoaiBaoCao.EditValue.ToString() == "BAOCAO_009")
                {
                    serf_pttt_loaiid = " pttt_loaiid=6 ";
                    chiachobacsi = " -(A.MOCHINH_TIEN * (A.TYLE/100))-(A.GIUPVIEC1_TIEN * (A.TYLE/100)) ";
                    serf_nhomdichvu = " and servicepricegroupcode = 'NSDDTT37_TT1' ";
                    serf_bhyt_groupcode = " bhyt_groupcode='04CDHA' ";
                    ser_bhyt_groupcode = " ser.bhyt_groupcode='04CDHA' ";
                    baocaotungloai = " pttt.phauthuatvien as mochinh_tenbs, ((case serf.pttt_loaiid when 6 then 37500 else 0 end) * ser.soluong) as mochinh_tien, 0 as moimochinh_tenbs, 0 as moimochinh_tien, 0 as gayme_tenbs, 0 as gayme_tien, 0 as moigayme_tenbs, 0 as moigayme_tien, 0 as phu1_tenbs, 0 as phu1_tien, 0 as phu2_tenbs, 0 as phu2_tien, pttt.phumo3 as giupviec1_tenbs, ((case serf.pttt_loaiid when 6 then 21000 else 0 end) * ser.soluong) as giupviec1_tien, 0 as giupviec2_tenbs, 0 as giupviec2_tien, ";
                }
