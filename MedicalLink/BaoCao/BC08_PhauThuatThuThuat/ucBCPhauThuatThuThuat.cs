    ...
    public partial class ucBCPhauThuatThuThuat : UserControl
    {
        ...
        private void tbnExportBCPTTTTheoFilter_Click()
        {
            try
            {
                ...
                {
                    fileTemplatePath = "BC_08_PhauThuatThuThuat_ChiTiet_CHUNG.xlsx";
                }
        ...
        private void chkLayChiTietHP_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                if (chkLayChiTietHP.Checked)
                {
                    gridBand_ThuocChiTietTrongGoi.Visible = true;
                    gridBand_VatTuChiTietTrongGoi.Visible = true;
                }
                else
                {
                    gridBand_ThuocChiTietTrongGoi.Visible = false;
