    ...
    public partial class ucBaoCaoBenhNhanNgoaiTru : UserControl
    {
        internal void LayDuLieuBaoCao_ChayMoi()
        {
            ...
            try
            {
                ...
                //if (cboLayTheo.Text == "Theo phòng ra viện")
                //{ 

                //}
                //else if (cboLayTheo.Text == "Theo phòng chỉ định")
                //{
