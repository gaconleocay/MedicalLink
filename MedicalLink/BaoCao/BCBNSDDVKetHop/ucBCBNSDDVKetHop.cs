    ...
    public partial class ucBCBNSDDVKetHop : UserControl
    {
        ...
        private void LoadDanhMucThuocVatTu()
        {
            try
            {
                ...
                DataTable dataMedicine = condb.getDataTable(sqlgetdata);
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    dataDSBenhNhan = condb.getDataTable(sqlquerry);
        ...
        private void gridControlDSBenhNhan_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataView dataServiceprice = new DataView(condb.getDataTable(sql_serviceprice));
