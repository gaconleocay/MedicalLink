...
LEFT JOIN	
		...
		FROM
			...
			from (select vp.vienphiid from vienphi vp where vp." + _loaitrangthai + " " + doituongbenhnhanid_vp + " and vp." + loaithoigian + " between '" + thoiGianTu + "' and '" + thoiGianDen + "' ) vp
				inner join (select servicepriceid,vienphiid,servicepricecode,soluong,departmentgroupid from serviceprice where bhyt_groupcode='03XN' and loaidoituong in (1,4,6)) ser on ser.vienphiid=vp.vienphiid
