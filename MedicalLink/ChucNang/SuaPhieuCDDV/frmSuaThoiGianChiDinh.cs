    ...
    public partial class frmSuaThoiGianChiDinh : Form
    {
        ...
        private void btnSuaThoiGian_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //Log
                string sqlinsert_log = "INSERT INTO tools_tbllog(loguser, logvalue, ipaddress, computername, softversion, logtime) VALUES ('" + SessionLogin.SessionUsercode + "', 'Sửa thời gian chỉ định Mã Viện phí=" + this.vienphiId + " - Mã phiếu chỉ định=" + this.maubenhphamId + ". từ: " + this.thoigianchidinh.ToString("yyyy-MM-dd HH:mm:ss") + "=> " + tg_chidinh + " ; thời gian sử dụng từ: " + this.thoigiansudung.ToString("yyyy-MM-dd HH:mm:ss") + " => " + tg_sudung + "; ID phiếu điều trị từ: " + this.phieudieutriId + "=> " + cboPhieuDieuTri.EditValue.ToString() + " ', '" + SessionLogin.SessionMyIP + "', '" + SessionLogin.SessionMachineName + "', '" + SessionLogin.SessionVersion + "', '" + datetime + "');";
