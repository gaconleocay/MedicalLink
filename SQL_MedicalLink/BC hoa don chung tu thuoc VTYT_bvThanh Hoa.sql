...
SELECT 
	(row_number() over (partition by kho.medicinestoreremark order by msb.medicinestorebilldate)) as stt,	
	...
	'' as nguoinhanhang,
	msb.medicinestoreid,
	kho.medicinestorename,
	kho.medicinestoreremark as khonhanhang,
...
FROM (select medicinestorebillid,medicinestorebillcode,medicinestorebilldate,sochungtu,medicinestorebilltotalmoney,partnerid,customername,ngaychungtu,medicinestoreid,medicinestorebillremark from medicine_store_bill 
	...
	INNER JOIN (select medicinestoreid,medicinestorename,medicinestoreremark from medicine_store) kho on kho.medicinestoreid=msb.medicinestoreid;
