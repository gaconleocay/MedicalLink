...
namespace MedicalLink.Dashboard
{
    public partial class ucDashboardBenhNhanNoiTru : UserControl
    {
        internal void LayDuLieuBaoCao_ChayMoi()
        {
            ...
            try
            {
                thoiGianTu = System.DateTime.ParseExact(this.dateTuNgay.Text, "HH:mm:ss dd/MM/yyyy", CultureInfo.InvariantCulture).ToString("yyyy-MM-dd HH:mm:ss");
