---update du lieu vao bang tools_serviceprice_pttt ngay  v 1.16 ngay 21/7
...
FROM (select vienphiid,patientid,bhytid,hosobenhanid,loaivienphiid,vienphistatus,departmentgroupid,departmentid,doituongbenhnhanid,vienphidate,vienphidate_ravien,duyet_ngayduyet,vienphistatus_vp,duyet_ngayduyet_vp,vienphistatus_bh,duyet_ngayduyet_bh,bhyt_tuyenbenhvien 
		...
		where 
	--da thanh toan
			/*duyet_ngayduyet_vp between '2013-01-01 00:00:00' and '2013-12-31 23:59:59'
			--and vienphiid not in (select vienphiid from tools_serviceprice_pttt)
			and vienphistatus_vp=1 
			and vienphistatus>0
	*/
	--ra vien chua thanh toan
			/*
			vienphidate_ravien between '2013-01-01 00:00:00' and '2013-12-31 23:59:59'
			--and vienphiid not in (select vienphiid from tools_serviceprice_pttt)
...
/*
select count(*) from tools_serviceprice_pttt where duyet_ngayduyet_vp between '2016-10-25 00:00:00' and '2016-10-25 23:59:59'
