    ...
    public partial class BCPhauThuat_YeuCau : UserControl
    {
        ...
        private void LoadDanhSachExport()
        {
            try
            {
                ...
                menu.Items.Add(new DXMenuItem("Xuất báo cáo phẫu thuật thủ thuật yêu cầu"));
                menu.Items.Add(new DXMenuItem("Xuất báo cáo thanh toán tiền phẫu thuật thủ thuật yêu cầu"));
                // ... add more items
        ...
        private void LoadDanhSachDichVu()
        {
            try
            {
                string sqlservice = "select servicepricecode, servicepricename from servicepriceref where servicepricecode in ('U11970-3701', 'U11620-4506', 'U11621-4524', 'U11622-4536', 'U11623-4610') order by servicepricename;";
                DataTable dataService = condb.GetDataTable(sqlservice);
        ...
        void Item_Export_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (tenbaocao == "Xuất báo cáo phẫu thuật thủ thuật yêu cầu")
                {
                    tbnExportBCPTTT_Click();
                }
                if (tenbaocao == "Xuất báo cáo thanh toán tiền phẫu thuật thủ thuật yêu cầu")
                {
