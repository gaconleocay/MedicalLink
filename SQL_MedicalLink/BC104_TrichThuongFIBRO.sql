...
FROM 
	...
	INNER JOIN (select maubenhphamid,maubenhphamstatus,maubenhphamdate,userid,departmentid_des from maubenhpham where maubenhphamgrouptype=1 "+_tieuchi_mbp+") mbp on mbp.maubenhphamid=ser.maubenhphamid		
