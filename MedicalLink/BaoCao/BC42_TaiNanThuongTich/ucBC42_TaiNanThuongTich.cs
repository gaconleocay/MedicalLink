    ...
    public partial class ucBC42_TaiNanThuongTich : UserControl
    {
        ...
        private void LoadTemplate_LableBaoCao()
        {
            try
            {
                ...
                DataTable _dataTmp = condb.GetDataTable_MeL(_sqldata);
                lstTNTT_Lable = Utilities.Util_DataTable.DataTableToList<BC42_TaiNanThuongTich_LableDTO>(_dataTmp);
            }
            catch (Exception ex)
            {
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    List<BC42_TaiNanThuongTichDTO> _lstTNTT = Util_DataTable.DataTableToList<BC42_TaiNanThuongTichDTO>(_dataBaoCao);
        ...
        private void tbnExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                export.ExportExcelTemplate("", fileTemplatePath, thongTinThem, Util_DataTable.ListToDataTable(this.lstBaoCao));
            }
            catch (Exception ex)
            {
                MedicalLink.Base.Logging.Warn(ex);
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string fileTemplatePath = "BC_42_ThongKeTaiNanThuongTich.xlsx"; Utilities.PrintPreview.PrintPreview_ExcelFileTemplate.ShowPrintPreview_UsingExcelTemplate(fileTemplatePath, thongTinThem, Util_DataTable.ListToDataTable(this.lstBaoCao));
            }
            catch (Exception ex)
            {
                Base.Logging.Warn(ex);
