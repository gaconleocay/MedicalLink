...
inner join 
	(select servicepricecode,pttt_loaiid from servicepriceref where servicegrouptype=4 and pttt_loaiid in (0,5,6,7,8) and servicepricegroupcode<>'PTYC') serf on serf.servicepricecode=ser.servicepricecode
inner join 
