    ...
    public partial class ucBCBHYT21Chenh2018 : UserControl
    {
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (cbbDoiTuongBN.Text == "BHYT")
                {
                    _sql_timkiem = @"SELECT 'A.Nội tỉnh' as ngoaitinh, vp.loaivienphiid, vp.doituongbenhnhanid, serf.servicepricecodeuser, serf.bhyt_groupcode, serf.servicepricecode, serf.servicepricenamebhyt, cast(coalesce(serf.servicepricefeebhyt,0) as numeric) as servicepricefee, ser.servicepricemoney_bhyt as servicepricemoney, sum((case when vp.loaivienphiid=0 and serf.bhyt_groupcode='01KB' and ser.lankhambenh>0 then 0 else ser.soluong end)) as soluong, ((ser.servicepricemoney_bhyt/cast(coalesce(serf.servicepricefeebhyt,0) as numeric)) * 100) as tyle, sum(ser.servicepricemoney_bhyt*(case when vp.loaivienphiid=0 and serf.bhyt_groupcode='01KB' and ser.lankhambenh>0 then 0 else ser.soluong end)) as thanhtien FROM (select * from vienphi where 1=1 " + _tieuchi_vp + _doituongBN + _trangthai_vp + _loaivienphi + ") vp inner join (select * from serviceprice where bhyt_groupcode in ( '01KB','03XN','04CDHA','05TDCN','06PTTT','07KTC','12NG','999DVKHAC','1000PhuThu','11VC') " + _tieuchi_ser + _loaidoituong + ") ser on ser.vienphiid=vp.vienphiid inner join (select * from servicepriceref where bhyt_groupcode in ( '01KB','03XN','04CDHA','05TDCN','06PTTT','07KTC','12NG','999DVKHAC','1000PhuThu','11VC')) serf on serf.servicepricecode=ser.servicepricecode inner join (select bhytid from bhyt where substring(bhytcode,4,2)='" + this.maTinhThanh + "') bh on bh.bhytid=vp.bhytid GROUP BY vp.loaivienphiid, vp.doituongbenhnhanid, serf.servicepricecodeuser, serf.bhyt_groupcode, serf.servicepricecode, serf.servicepricenamebhyt, serf.servicepricefeebhyt, ser.servicepricemoney_bhyt, ser.lankhambenh, ser.loaingaygiuong, ser.loaipttt UNION ALL SELECT 'B.Ngoại tỉnh' as ngoaitinh, vp.loaivienphiid, vp.doituongbenhnhanid, serf.servicepricecodeuser, serf.bhyt_groupcode, serf.servicepricecode, serf.servicepricenamebhyt, cast(coalesce(serf.servicepricefeebhyt,0) as numeric) as servicepricefee, ser.servicepricemoney_bhyt as servicepricemoney, sum((case when vp.loaivienphiid=0 and serf.bhyt_groupcode='01KB' and ser.lankhambenh>0 then 0 else ser.soluong end)) as soluong, ((ser.servicepricemoney_bhyt/cast(coalesce(serf.servicepricefeebhyt,0) as numeric)) * 100) as tyle, sum(ser.servicepricemoney_bhyt*(case when vp.loaivienphiid=0 and serf.bhyt_groupcode='01KB' and ser.lankhambenh>0 then 0 else ser.soluong end)) as thanhtien FROM (select * from vienphi where 1=1 " + _tieuchi_vp + _doituongBN + _trangthai_vp + _loaivienphi + ") vp inner join (select * from serviceprice where bhyt_groupcode in ( '01KB','03XN','04CDHA','05TDCN','06PTTT','07KTC','12NG','999DVKHAC','1000PhuThu','11VC') " + _tieuchi_ser + _loaidoituong + ") ser on ser.vienphiid=vp.vienphiid inner join (select * from servicepriceref where bhyt_groupcode in ( '01KB','03XN','04CDHA','05TDCN','06PTTT','07KTC','12NG','999DVKHAC','1000PhuThu','11VC')) serf on serf.servicepricecode=ser.servicepricecode inner join (select bhytid from bhyt where substring(bhytcode,4,2)<>'" + this.maTinhThanh + "') bh on bh.bhytid=vp.bhytid GROUP BY vp.loaivienphiid, vp.doituongbenhnhanid, serf.servicepricecodeuser, serf.bhyt_groupcode, serf.servicepricecode, serf.servicepricenamebhyt, serf.servicepricefeebhyt, ser.servicepricemoney_bhyt, ser.lankhambenh, ser.loaingaygiuong, ser.loaipttt;";
                }
                else//vien phi
                {
                    _sql_timkiem = @"SELECT '' as ngoaitinh, vp.loaivienphiid, vp.doituongbenhnhanid, serf.servicepricecodeuser, serf.bhyt_groupcode, serf.servicepricecode, serf.servicepricenamebhyt, cast(coalesce(serf.servicepricefee,'0') as numeric) as servicepricefee, ser.servicepricemoney, sum((case when vp.loaivienphiid=0 and serf.bhyt_groupcode='01KB' and ser.lankhambenh>0 then 0 else ser.soluong end)) as soluong, ((ser.servicepricemoney/cast(coalesce(serf.servicepricefee,'0') as numeric)) * 100) as tyle, sum(ser.servicepricemoney*(case when vp.loaivienphiid=0 and serf.bhyt_groupcode='01KB' and ser.lankhambenh>0 then 0 else ser.soluong end)) as thanhtien FROM (select * from vienphi where 1=1 " + _tieuchi_vp + _doituongBN + _trangthai_vp + _loaivienphi + ") vp inner join (select * from serviceprice where bhyt_groupcode in ( '01KB','03XN','04CDHA','05TDCN','06PTTT','07KTC','12NG','999DVKHAC','1000PhuThu','11VC') " + _tieuchi_ser + _loaidoituong + ") ser on ser.vienphiid=vp.vienphiid inner join (select * from servicepriceref where bhyt_groupcode in ( '01KB','03XN','04CDHA','05TDCN','06PTTT','07KTC','12NG','999DVKHAC','1000PhuThu','11VC')) serf on serf.servicepricecode=ser.servicepricecode GROUP BY vp.loaivienphiid, vp.doituongbenhnhanid, serf.servicepricecodeuser, serf.bhyt_groupcode, serf.servicepricecode, serf.servicepricenamebhyt, serf.servicepricefee, ser.servicepricemoney, ser.lankhambenh, ser.loaingaygiuong, ser.loaipttt;";
                }
                    ...
                    string _sql_dataChenh = @"SELECT (row_number() OVER (PARTITION BY O.tennhom_bhyt ORDER BY O.ngoaitinh,O.servicepricenamebhyt)) as stt, O.*
                        FROM
	                        (SELECT distinct chenh.datachenh2018tmpid,
		                        ...
		                        chenh.servicepricemoney,
		                        chenh.thanhtien as thanhtien_17a,
