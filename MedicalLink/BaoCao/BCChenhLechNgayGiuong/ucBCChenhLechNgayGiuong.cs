    ...
    public partial class ucBCChenhLechNgayGiuong : UserControl
    {
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    this.lstDataBaoCaoCurrent = DataTables.DataTableToList<ClassCommon.BCChenhLechNgayGiuongDTO>(dataBaoCao);
        ...
        private DataTable ExportExcel_GroupColume()
        {
            ...
            try
            {
                ...
                lstDataDoanhThu = DataTables.DataTableToList<ClassCommon.BCChenhLechNgayGiuongDTO>(Utilities.GridControl.Util_GridcontrolConvert.ConvertGridControlToDataTable(gridViewDataBaoCao));
