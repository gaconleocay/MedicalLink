---update du lieu vao bang ihs_servicespttt ngay  v 1.15 ngay 15/7
...
WHERE vp.duyet_ngayduyet_vp  >= '2017-07-11 23:59:59'
		and COALESCE(vp.vienphistatus_vp,0)=1
	
	/*vp.vienphiid in (select vienphiid
			from vienphi
			where COALESCE(vienphistatus_vp,0)=0 and vienphistatus<>0
				and  vienphidate_ravien>='2016-11-01 00:00:00'
...
where COALESCE(vp.vienphistatus_vp,0)=0
	...
	and vp.vienphiid not in (select vienphiid from ihs_servicespttt )
