...
{
    public partial class BCBenhNhanNoiTruTuyChonNangCao : Form
    {
        ...
        public BCBenhNhanNoiTruTuyChonNangCao()
        {
            InitializeComponent();
        }

        private void BCBenhNhanNoiTruTuyChonNangCao_Load(object sender, EventArgs e)
        {
            try
            {
