...
namespace MedicalLink.FormCommon
{
    internal static class KetNoiSCDLProcess
    {
        ...
        internal static bool CapNhatCoSoDuLieu()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi Update DB" + ex.ToString());
            }
            return result;
        }
        ...
        private static bool CreateTableTblUser()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableTblUser" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableTblPermission()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableTblPermission" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableTblLog()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableTblLog" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableTblUpdateKhaDung()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableTblUpdateKhaDung" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableColumeBackupDichVu()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableColumeBackupDichVu" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableTblDVKTBHYTChenh()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableTblDVKTBHYTChenh" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableTblDVKTBHYTChenhNew()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableTblDVKTBHYTChenhNew" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableOption()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableOption" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableUserDepartmentgroup()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableUserDepartmentgroup" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableVersion()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableSersion" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableLicense()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableLicense" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableTblNhanVien()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableTblNhanVien" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableUserMedicineStore()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableUserMedicineStore" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableUserMedicinePhongLuu()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableUserMedicinePhongLuu" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableToolsServicepricePttt()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableToolsServicepricePttt" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableOtherTypeList()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableOtherTypeList" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableOtherList()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableOtherList" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableNhomPersonnel()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableNhomPersonnel" + ex.ToString());
            }
            return result;
        }
        private static bool CreateTableIhsServicespttt()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTableIhsServicespttt" + ex.ToString());
            }
            return result;
        }
        ...
        private static bool CreateTabletools_billedit()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateTabletools_billedit" + ex.ToString());
            }
            return result;
        }
        ...
        private static bool CreateViewServicepriceDepartment()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateViewServicepriceDepartment" + ex.ToString());
            }
            return result;
        }
        private static bool CreateViewServicepriceMoney()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateViewServicepriceMoney" + ex.ToString());
            }
            return result;
        }
        private static bool CreateViewVienPhimoney_SoBN()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateViewVienPhimoney_SoBN" + ex.ToString());
            }
            return result;
        }
        private static bool CreateViewVienPhimoney_TM()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateViewVienPhimoney_TM" + ex.ToString());
            }
            return result;
        }
        private static bool Createview_tools_serviceprice_pttt()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi tao VIEW Createview_tools_serviceprice_pttt" + ex.ToString());
            }
            return result;
        }
        ...
        private static bool CreateFunctionByteaImport()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CreateFunctionByteaimport" + ex.ToString());
            }
            return result;
        }
        #endregion
        ...
        private static bool CapNhat_OtherList()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi CapNhat_OtherList" + ex.ToString());
            }
            return result;
        }
        ...
        private static bool UpdateTableLog()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi tools_tbllog" + ex.ToString());
            }
            return true;
        }
        private static bool UpdateTableDepartmentGroup()
        {
            ...
            {
                O2S_Common.Logging.LogSystem.Error("Lỗi departmentgroup" + ex.ToString());
            }
            return true;
        }
