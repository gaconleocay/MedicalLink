...
{
    public partial class ucBC107_KhamBenhChiTiet : UserControl
    {
        #region Khai bao
        private Base.ConnectDatabase condb = new MedicalLink.Base.ConnectDatabase();
        #endregion

        public ucBC107_KhamBenhChiTiet()
        {
            InitializeComponent();
        }
