...
---Báo cáo Thực hiện PTTT Chuyên khoa_ngày 31/3/2017: 
...
(case when pttt.phauthuatvien2>0 then pttt.phauthuatvien2
	  else 0 end) as moimochinh_tenbs,
(case when pttt.phauthuatvien2>0 then ((case serf.pttt_loaiid 
											when 1 then 280000 
											when 2 then 125000 
											when 3 then 56000 
											else 0 end) * ser.soluong)
	  else 0 end) as moimochinh_tien,		
pttt.bacsigayme as gayme_tenbs,  
((case serf.pttt_loaiid 
		when 1 then 280000 
		when 2 then 125000 
...
((case serf.pttt_loaiid 
		...
		when 3 then 50000 
		when 4 then 30000 
		else 0 end) * ser.soluong) as phume_tien,  
pttt.phumo1 as phu1_tenbs,  
((case serf.pttt_loaiid 
		when 1 then 200000 
		when 2 then 90000 
