        ...
        private void HienThiDuLieu(List<DataView> dataBC)
        {
            try
            {
               ...
               // dataRow_3.DoanhThuTongGM_name = "Khám bệnh";
                ...
                dataRow_15.RaVienChuaTT_stt = 15;
                dataRow_15.RaVienChuaTT_name = "PTTT yêu cầu";
                dataRow_15.RaVienChuaTT_value = Util_NumberConvert.NumberToString(Utilities.Util_TypeConvertParse.ToDecimal(dataBC[2][0]["ravienchuatt_tienptttyeucau"].ToString()), 0) + " đ";
                dataRow_15.RaVienChuaTT_unit = "";
                dataRow_15.DaTT_value = Util_NumberConvert.NumberToString(Utilities.Util_TypeConvertParse.ToDecimal(dataBC[3][0]["raviendatt_tienptttyeucau"].ToString()), 0) + " đ";
                dataRow_15.DoanhThu_name = "PTTT yêu cầu";
                dataRow_15.DoanhThu_value = Util_NumberConvert.NumberToString(Utilities.Util_TypeConvertParse.ToDecimal(dataBC[4][0]["doanhthu_tienptttyeucau"].ToString()), 0) + " đ";
                //dataRow_15.DoanhThuGM_name = "PTTT yêu cầu";
                dataRow_15.DoanhThuGM_value = Util_NumberConvert.NumberToString(Utilities.Util_TypeConvertParse.ToDecimal(dataBC[4][0]["doanhthugm_tienptttyeucau"].ToString()), 0) + " đ";
                //dataRow_15.DoanhThuTongGM_name = "PTTT yêu cầu";
                dataRow_15.DoanhThuTongGM_value = Util_NumberConvert.NumberToString(Utilities.Util_TypeConvertParse.ToDecimal(dataBC[4][0]["doanhthutonggm_tienptttyeucau"].ToString()), 0) + " đ";
                ...
                dataRow_16.RaVienChuaTT_stt = 14;
                dataRow_16.RaVienChuaTT_name = "VT TT riêng";
                dataRow_16.RaVienChuaTT_value = Util_NumberConvert.NumberToString(Utilities.Util_TypeConvertParse.ToDecimal(dataBC[2][0]["ravienchuatt_tienvattu_ttrieng"].ToString()), 0) + " đ";
                dataRow_16.RaVienChuaTT_unit = "";
                dataRow_16.DaTT_value = Util_NumberConvert.NumberToString(Utilities.Util_TypeConvertParse.ToDecimal(dataBC[3][0]["raviendatt_tienvattu_ttrieng"].ToString()), 0) + " đ";
                dataRow_16.DoanhThu_name = "VT TT riêng";
                dataRow_16.DoanhThu_value = Util_NumberConvert.NumberToString(Utilities.Util_TypeConvertParse.ToDecimal(dataBC[4][0]["doanhthu_tienvattu_ttrieng"].ToString()), 0) + " đ";
                //dataRow_16.DoanhThuGM_name = "VT TT riêng";
                dataRow_16.DoanhThuGM_value = Util_NumberConvert.NumberToString(Utilities.Util_TypeConvertParse.ToDecimal(dataBC[4][0]["doanhthugm_tienvattu_ttrieng"].ToString()), 0) + " đ";
                //dataRow_16.DoanhThuTongGM_name = "VT TT riêng";
                dataRow_16.DoanhThuTongGM_value = Util_NumberConvert.NumberToString(Utilities.Util_TypeConvertParse.ToDecimal(dataBC[4][0]["doanhthutonggm_tienvattu_ttrieng"].ToString()), 0) + " đ";
