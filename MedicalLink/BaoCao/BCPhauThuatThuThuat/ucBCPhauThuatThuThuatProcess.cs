    ...
    public partial class ucBCPhauThuatThuThuat : UserControl
    {
        ...
        internal void LayDuLieuBaoCao_ChayMoi()
        {
            ...
            try
            {
                ...
                {
                    _tieuchi_vp = " and vienphidate between '" + tungay + "' and '" + denngay + "' ";
                    _tieuchi_ser = " and servicepricedate>='" + tungay + "' ";
                }
                else if (cboTieuChi.Text == "Theo ngày ra viện")
                {
                    _tieuchi_vp = " and vienphidate_ravien between '" + tungay + "' and '" + denngay + "' ";          
                }
