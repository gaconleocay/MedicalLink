--Sổ Phẫu thuật Lam sang
--ucBC45_SoPhauThuatLamSang
--pttt_loaiid not in (5,6,7,8)
...
inner join 
	(select servicepricecode,pttt_loaiid from servicepriceref where servicegrouptype=4 and pttt_loaiid not in (5,6,7,8) and servicepricegroupcode<>'PTYC') serf on serf.servicepricecode=ser.servicepricecode
inner join 
