            ...
            try
            {
                ...
                if (dv_DanhMucDichVu.Count > 0)
                {
                    ...
                    for (int i = 0; i < dv_DanhMucDichVu.Count; i++)
                    {
                        ...
                        dmDichVu.toolsservicerefid = Utilities.TypeConvertParse.ToInt64(dv_DanhMucDichVu[i]["toolsservicerefid"].ToString());
                        dmDichVu.his_servicepricerefid = Utilities.TypeConvertParse.ToInt64(dv_DanhMucDichVu[i]["his_servicepricerefid"].ToString());
                        dmDichVu.servicepricetype = Utilities.TypeConvertParse.ToInt64(dv_DanhMucDichVu[i]["servicepricetype"].ToString());
                        dmDichVu.servicegrouptype = Utilities.TypeConvertParse.ToInt64(dv_DanhMucDichVu[i]["servicegrouptype"].ToString());
                        ...
                        dmDichVu.servicepricefee = Utilities.TypeConvertParse.ToDecimal(dv_DanhMucDichVu[i]["servicepricefee"].ToString());
                        dmDichVu.servicepricefeenhandan = Utilities.TypeConvertParse.ToDecimal(dv_DanhMucDichVu[i]["servicepricefeenhandan"].ToString());
                        dmDichVu.servicepricefeebhyt = Utilities.TypeConvertParse.ToDecimal(dv_DanhMucDichVu[i]["servicepricefeebhyt"].ToString());
                        dmDichVu.servicepricefeenuocngoai = Utilities.TypeConvertParse.ToDecimal(dv_DanhMucDichVu[i]["servicepricefeenuocngoai"].ToString());
                        dmDichVu.servicelock = Utilities.TypeConvertParse.ToInt16(dv_DanhMucDichVu[i]["servicelock"].ToString());
                        ...
                        dmDichVu.pttt_hangid = Utilities.TypeConvertParse.ToInt16(dv_DanhMucDichVu[i]["pttt_hangid"].ToString());
                        dmDichVu.pttt_loaiid = Utilities.TypeConvertParse.ToInt16(dv_DanhMucDichVu[i]["pttt_loaiid"].ToString());
                        dmDichVu.tools_otherlistid = Utilities.TypeConvertParse.ToInt64(dv_DanhMucDichVu[i]["tools_otherlistid"].ToString());
