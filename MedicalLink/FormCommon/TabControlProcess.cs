            ...
            try
            {
                switch (ucName)
                {
                    ...
                    case "TOOL_04":
                        ...
                        break;
                    case "TOOL_05":
                        ucResult = new ChucNang.ucTOOL05_XuLyBNBoKhoa();
                        break;
                    case "TOOL_06":
                    ...
                    case "TOOL_26":
                        ...
                        break;
                    case "TOOL_27":
                        ucResult = new ChucNang.ucTool27_KiemTraKetNoiPostgre();
                        break;
                    case "TOOL_28":
                        ucResult = new ChucNang.ucTool28_FixLoiSaiMauBanPham();
                        break;

                    //Bao cao
                    case "REPORT_01":
                        ucResult = new BaoCao.ucBC01_DSBNSDdv();
                        break;
                    case "REPORT_02":
                    ...
                    case "REPORT_16":
                        ...
                        break;
                    case "REPORT_17":
                        ucResult = new BaoCao.BC17_PhauThuat_YeuCau();
                        break;
                    case "REPORT_18":
                    ...
                    case "REPORT_28":
                        ...
                        break;
                    case "REPORT_29":
                        ucResult = new BaoCao.ucBC29_ThucHienCLS_UngBuou();
                        break;
                    case "REPORT_30":
                    ...
                    case "REPORT_32":
                        ...
                        break;
                    case "REPORT_33":
                        ucResult = new BaoCao.ucBC33_ThucHienCLS_TongHop();
                        break;
                    case "REPORT_34":
                    ...
                    case "REPORT_53":
                        ...
                        break;
                    case "REPORT_57":
                        ucResult = new BaoCao.ucBC57_KeThuocVatTuTruocNgay();
                        break;
                    case "REPORT_58":
                        ucResult = new BaoCao.ucBC58_SuDungVatTuTheoNhom();
                        break;
