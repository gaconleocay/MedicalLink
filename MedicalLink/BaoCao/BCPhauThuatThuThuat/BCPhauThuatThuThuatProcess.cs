    ...
    public partial class BCPhauThuatThuThuat : UserControl
    {
        internal void LayDuLieuBaoCao_ChayMoi()
        {
            ...
            try
            {
                ...
                else if (cboLoaiBaoCao.EditValue.ToString() == "BAOCAO_004") //phau thuat - lay phong mo mat + phong kham mổ mat + BDT khoa mat: ser.departmentid in (269,335)
                {
                    ser_departmentid = " ser.departmentid in (269,335,80) ";
                    serf_pttt_loaiid = " serf.pttt_loaiid in (1,2,3,4) ";
