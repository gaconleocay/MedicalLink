...
inner join 
	(select servicepricecode,pttt_loaiid from servicepriceref where servicegrouptype=4 and pttt_loaiid in (1,2,3,4) and servicepricegroupcode<>'PTYC') serf on serf.servicepricecode=ser.servicepricecode
inner join 
