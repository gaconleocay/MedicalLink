    ...
    public partial class ucBCDoanhThuTheoMayXN : UserControl
    {
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sql_getdata = @"SELECT ROW_NUMBER() OVER (ORDER BY SERV.ten_xn) as stt,
